...
knitr::opts_chunk$set(echo = FALSE,fig.width=7, fig.height=5.5, warning = FALSE)
...
4. Discard and redraw households with cerain probabilities

5. Check objective function again

6. Repeat 4. and 5. until distributions "differ" by $\epsilon$
